...
//         </div>
//         <button className="btn btn-primary branch-add-btn">
...
//                 <td data-label="Manager">{branch.manager}</td>
//                 <td data-label="Customers">{branch.customers}</td>
//                 <td data-label="Accounts">{branch.accounts}</td>
//                 <td data-label="Status">
//                   <span
//                     className={`branch-badge ${branch.status === "Active" ? "bg-success" : "bg-secondary"}`}
//                   >
//                     {branch.status}
//                   </span>
//                 </td>
...
//                     <button
//                       className="branch-action-btn branch-action-view"
//                       title="View"
//                     >
//                       <i className="bi bi-eye"></i>
//                     </button>
//                     <button
//                       className="branch-action-btn branch-action-edit"
//                       title="Edit"
//                     >
//                       <i className="bi bi-pencil"></i>
//                     </button>
//                     <button
//                       className="branch-action-btn branch-action-delete"
//                       title="Delete"
//                     >
